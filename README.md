...
-u : Использовать при сортировке (опция -t) или перечислении (опция -l) время последнего доступа к файлу
     вместо времени последней модификации файла.
-f : Не сортировать содержимое каталога, включает опцию -a. Опции -l, --color, -s, и -t игнорируются, если они заданы перед -f.
-g : Как -l, но не выводит имя владельца.
